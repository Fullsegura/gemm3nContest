...
cred = credentials.Certificate("fullsegura-55e8c-firebase-adminsdk-rd7b7-328cf3b69e.json")  # ← cambia a la ruta real
firebase_admin.initialize_app(cred)
db = firestore.client()

# Firebase prompt listener
...
def vlm_callback(prompt, reply, **kwargs):
    ...
    if reply and "yes" in reply.lower() and alert:
        ...
        sleep(3)  # Allow time for WebSocket to process the message
